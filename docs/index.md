...
hero:
  name: "Laravel 13"
  text: "Documentation Tiếng Việt"
  tagline: "Bản dịch cộng đồng không chính thức — rõ ràng, bám sát tài liệu gốc và dễ đối chiếu khi học Laravel."
  actions:
    - theme: brand
      text: Bắt đầu với Laravel
      link: /installation
    - theme: alt
      text: Tài liệu chính thức
      link: https://laravel.com/docs/13.x

features:
  - title: Bám sát Laravel 13.x
